...
const testimonials = [
  {
    quote:
      "המדריכות פשוט מדהימות, שמות לב לכל תנועה קטנה ומדייקות אותי בכל שיעור מחדש.",
    author: "שרה",
    title: "מתאמנת מ-2023",
  },
  {
    quote:
      "המקום הוא המפלט שלי מהלחץ של היום-יום. עיצוב נקי, אנרגיה מטורפת ויחס אישי באמת.",
    author: "יעל",
    title: "מתאמנת מ-2022",
  },
  {
    quote:
      "הסטודיו הזה שינה לי את החיים. כאבי הגב נעלמו ואני מרגישה חזקה יותר מאי פעם.",
    author: "מיכל",
    title: "מתאמנת מ-2024",
  },
  {
    quote:
      "אחרי שניסיתי אינספור סטודיואים, BE PILATES בולט מכולם. השילוב של הדרכה מקצועית ואווירה יוקרתית הופך כל שיעור למיוחד.",
    author: "רונית",
    title: "מתאמנת מ-2023",
  },
]
